...
//        running = false;
    ...
    private void makeControls()
    {
        ...
        stepButton = new JButton(parentFrame.getWorld().getStep());
        runButton = new JButton(parentFrame.getWorld().getRun());
        stopButton = new JButton(parentFrame.getWorld().getStop());
